    ...
    IConfiguration configuration) : IPromptSecurityService
{
        ...
        SecurityContext context)
    {
        ...
        try
        {
            ...
            var maxRiskLevel = configuration.GetValue<RiskLevel>("Security:MaxPromptRiskLevel", RiskLevel.Medium);
    ...
    private Task<PromptValidationResult> ValidatePromptStructureAsync(string prompt)
    {
        ...
        // Check prompt length
        var maxLength = configuration.GetValue<int>("Security:MaxPromptLength", 50000);
