...
public class PromptAuditLogger : IPromptAuditLogger
{
    ...
    public PromptAuditLogger(ILogger<PromptAuditLogger> logger, IConfiguration configuration)
    {
        ...
        _auditLogPath = _configuration.GetValue<string>("Security:AuditLogPath", "logs/audit");
        _enableFileLogging = _configuration.GetValue<bool>("Security:EnableFileAuditLogging", true);
        _enableStructuredLogging = _configuration.GetValue<bool>("Security:EnableStructuredAuditLogging", true);
