...
public class ModellerPrompts
{
    ...
    [McpServerPrompt, Description("Validate mode definitions.")]
    public static string ValidateModelsPrompt([Description("Absolute path to the parent folder")] string folder) => $"Validate the defintion structure and  all the models within '{folder}'";
}
